<%@ Page Title="" Language="C#" MasterPageFile="~/Teacher.Master" AutoEventWireup="true" CodeBehind="Register_Teacher.aspx.cs" Inherits="SAD.Register_Teacher" %>
...
<asp:Content ID="Content2" ContentPlaceHolderID="ContentPlaceHolder1" runat="server">
      ...
      <div class="form-container">
        ...
        <div class="btn-container">
            ...
            <asp:Button ID="btnReset" runat="server" CssClass="btn" Text="Reset" CausesValidation="False" OnClick="btnReset_Click" />
        </div>
    </div>
</asp:Content>
